...
function _convertTypes (str, customFunc) {
  ...
  switch(type){
    ...
    default:
      return customFunc[type](content)
  }
}

function expand (config, customFunc = {}) {
  ...
  for (const configKey in config.parsed) {
    ...
    config.parsed[configKey] = _convertTypes(_resolveEscapeSequences(
